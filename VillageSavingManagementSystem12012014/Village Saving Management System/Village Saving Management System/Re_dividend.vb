...
Public Class Re_dividend
    ...
    Sub select_data()
        ...
        sql += " select * from vw_re_dividend where create_date >= '" + date_from + " 00:00:00' and  create_date <= '" + date_to + " 23:59:59'"
        dta = class_conn.selectbase(sql)

        ReportViewer1.LocalReport.DataSources.Clear()
        ReportViewer1.LocalReport.ReportPath = "..\..\Report\re_dividend.rdlc"
    ...
    Private Sub Re_dividend_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
