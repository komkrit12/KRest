...
Public Class all_customer_ferpay
    ...
    Sub load_data()
        ...
        If Me.cbo_search.Text = "ชื่อ" Then
            sql += " select distinct cust_id,cust_fname , cust_lname,contract_fer_no,cust_address,tel,personal_id,age,occupation,earnings_month,pay_date from vw_ferfer where cust_fname like '%" + Me.txt_search.Text + "%' and status is null and status_fercon is null order by cust_id asc"
        ElseIf Me.cbo_search.Text = "รหัสสมาชิก" Then
            sql += " select distinct cust_id,cust_fname , cust_lname,contract_fer_no,cust_address,tel,personal_id,age,occupation,earnings_month,pay_date from vw_ferfer where cust_id like '%" + Me.txt_search.Text + "%' and status is null and status_fercon is null order by cust_id asc"
        ElseIf Me.cbo_search.Text = "เลขบัตรประชาชน" Then
            sql += " select distinct cust_id,cust_fname , cust_lname,contract_fer_no,cust_address,tel,personal_id,age,occupation,earnings_month,pay_date from vw_ferfer where personal_id like '%" + Me.txt_search.Text + "%' and status is null and status_fercon is null order by cust_id asc"
    ...
    Private Sub DataGridView1_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        strconid = DataGridView1.Rows.Item(UserSelectRow).Cells("contract_fer_no").Value.ToString
