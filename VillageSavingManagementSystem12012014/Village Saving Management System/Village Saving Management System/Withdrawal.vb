...
Public Class Withdrawal
    ...
    Sub insert_data()
        ...
        withdrawal = Me.txt_wd.Text
        sum_balance = balance - withdrawal
        Dim sql As String = ""
        sql += " Insert into transection (cust_id,trans_type,trans_value,balance,time_create,createby)"
        sql += " Values ('" + Me.txt_id.Text + "','Withdrawal'," + Me.txt_wd.Text + "," + CStr(sum_balance) + ",getdate(), '" + Me.txt_create.Text + "' )"
    ...
    Sub check_data()
        If Me.txt_id.Text = "" Or Me.txt_wd.Text = "" Then
            MessageBox.Show("กรุณากรอกข้อมูลให้สมบูรณ์", "Village Saving Management System", MessageBoxButtons.OK, MessageBoxIcon.Warning)


        ElseIf Me.txt_wd.Text > Me.txt_balance.Text Then

            MessageBox.Show("จำนวนเงินในบัญชีไม่เพียงพอ", "Village Saving Management System", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Me.txt_wd.Text = ""
    ...
    Private Sub tst_save_ButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tst_save.ButtonClick
        If MsgBox("คุณต้องการบันทึกการถอนใช่หรือไม่" & "", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            check_data()
        End If
    ...
    Private Sub txt_wd_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_wd.TextChanged
        If Me.txt_wd.Text = "" Then
            Exit Sub
        End If

        If Not IsNumeric(Me.txt_wd.Text) Then
    ...
    Private Sub DataGridView1_CellContentClick_1(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        Me.txt_wd.Text = DataGridView1.Rows.Item(UserSelectRow).Cells("balance").Value.ToString
        cal_cost()
    End Sub
