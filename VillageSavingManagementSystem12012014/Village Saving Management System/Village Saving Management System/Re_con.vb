...
Public Class Re_con
    ...
    Sub select_data()
        ...
        sql += " select * from ve_re_con where time_create >= '" + date_from + "' and  time_create <= '" + date_to + "'"
        dta = class_conn.selectbase(sql)

        ReportViewer1.LocalReport.DataSources.Clear()
        ReportViewer1.LocalReport.ReportPath = "..\..\Report\re_con.rdlc"
    ...
    Private Sub Re_loan_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.ReportViewer1.RefreshReport()
    End Sub
