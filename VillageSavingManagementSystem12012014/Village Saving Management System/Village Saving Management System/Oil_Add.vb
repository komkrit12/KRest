...
Public Class Oil_Add
    Dim class_conn As New class_conn

    Sub insert_data()
        Dim sql As String = ""
        sql += " Insert into oil (oil_type,price,point,time_create,createby)"
    ...
    Sub cencel_data()
        ...
        If lb_status.Text = "-" Or lb_status.Text = "" Then
            sql += " UPDATE oil"
            sql += " SET status_oil = 'ยกเลิก'"
            sql += " WHERE oil_id=" + Me.lb_oilid.Text + ""
        End If
        If class_conn.writebase(sql) = True Then
            select_data()
    ...
    Private Sub Oil_Add_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        select_data()
        username_log()
    ...
    Private Sub DataGridView1_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        Me.lb_oilid.Text = DataGridView1.Rows.Item(UserSelectRow).Cells("oil_id").Value.ToString
        Me.lb_status.Text = DataGridView1.Rows.Item(UserSelectRow).Cells("status_oil").Value.ToString
        Me.txt_type.Text = DataGridView1.Rows.Item(UserSelectRow).Cells("oil_type").Value.ToString
    ...
    Private Sub txt_stock_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_point.TextChanged
        If txt_point.Text = "" Then
            Exit Sub
        End If

        If Not IsNumeric(txt_point.Text) Then
            MessageBox.Show("กรุณากรอกข้อมูลที่เป็นตัวเลขเท่านั้น", "Village Saving Management System", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            txt_point.Text = ""
        End If
    End Sub
