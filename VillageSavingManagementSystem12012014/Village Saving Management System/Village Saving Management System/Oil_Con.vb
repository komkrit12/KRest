...
Public Class Oil_Con
    ...
    Sub cus_id()
        ...
        sql += "select contract_oil_no from oil_contracts order by contract_oil_no desc"
        ...
        Else
            Dim a As String = ""
            Dim b As Integer
            a = dta.Rows(0).Item("contract_oil_no").ToString
            b = CInt(a) + 1
    ...
    Sub insert_data()
        ...
        Dim sql As String = ""
        sql += " Insert into oil_contracts (contract_oil_no,cust_id,create_date,guarantee_no1,createby)"
    ...
    Private Sub Oil_Con_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
