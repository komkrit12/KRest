...
Public Class Re_payment
    ...
    Sub select_data()
        ...
        sql += " select * from vw_re_pay where create_date >= '" + date_from + "' and  create_date <= '" + date_to + "'"
        dta = class_conn.selectbase(sql)

        ReportViewer1.LocalReport.DataSources.Clear()
        ReportViewer1.LocalReport.ReportPath = "..\..\Report\re_payment.rdlc"
    ...
    Private Sub Re_payment_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
