...
Public Class Re_customers
    ...
    Sub select_data()
        ...
        sql += " select * from vw_re_cust where time_create >= '" + date_from + "' and  time_create <= '" + date_to + "'"
        dta = class_conn.selectbase(sql)

        ReportViewer1.LocalReport.DataSources.Clear()
        ReportViewer1.LocalReport.ReportPath = "..\..\Report\re_cust.rdlc"
    ...
    Private Sub Re_customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
