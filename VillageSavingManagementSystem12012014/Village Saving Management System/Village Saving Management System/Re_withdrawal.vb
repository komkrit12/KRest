...
Public Class Re_withdrawal
    ...
    Sub select_data()
        ...
        sql += " select * from vw_re_tran where time_create >= '" + date_from + " 00:00:00' and  time_create <= '" + date_to + " 23:59:59' and trans_type = 'Withdrawal' "
        dta = class_conn.selectbase(sql)

        ReportViewer1.LocalReport.DataSources.Clear()
        ReportViewer1.LocalReport.ReportPath = "..\..\Report\re_withdrawal.rdlc"
