...
Public Class all_customer_con
    ...
    Sub load_data()
        ...
        If Me.cbo_search.Text = "ชื่อ" Then
            sql += " select * from customers where cust_fname like '%" + Me.txt_search.Text + "%' and status is null and con_status is null"
        ElseIf Me.cbo_search.Text = "รหัสสมาชิก" Then
            sql += " select * from customers where cust_id like '%" + Me.txt_search.Text + "%' and status is null and con_status is null"
        ElseIf Me.cbo_search.Text = "เลขบัตรประชาชน" Then
            sql += " select * from customers where personal_id like '%" + Me.txt_search.Text + "%' and status is null and con_status is null"
    ...
    Private Sub DataGridView1_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        'Dim sql As String = ""
        'Dim dta As DataTable
        'sql += " select * from vw_con_search where cust_id ='" + strid + "' and status is null and time_create >= '" + date_from + "-01-01 00:00:00' and time_create <= '" + date_from + "-12-31 23:59:59'"
        'dta = class_conn.selectbase(sql)
        ...
        '    sql2 += " select top 1 * from vw_cus_con where cust_id ='" + strid + "' and balance = 0 order by pay_id desc"
    ...
    Private Sub all_customer_con_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
